...
//            "o.ono, o.orderId, p.pno, p.title, o.ticketCount, o.totalPrice, pay.paymentMethod, pay.createdAt, o.status) " +
//            "FROM Order o LEFT JOIN o.payment pay LEFT JOIN o.performance p " +
...
//    List<MyReservationDto> findMyReservations(@Param("cId") Integer cId);
    ...
    @Query("SELECT new com.example.greenspringboot.order.dto.MyReservationDto(" +
            ...
            "FROM Order o " +
            "LEFT JOIN Payment pay ON o.ono = pay.ono " +  // 🔥 조인 조건 명시!
