...
<%--&lt;%&ndash;    <link rel="icon" type="image/x-icon" href="<c:url value="https://cdn-icons-png.flaticon.com/128/15439/15439306.png"/>">&ndash;%&gt;--%>
...
<%--&lt;%&ndash;        <article class="box">&ndash;%&gt;--%>
<%--&lt;%&ndash;            <div id="vinylBox">&ndash;%&gt;--%>
<%--&lt;%&ndash;                <h1 class="week">Album</h1>&ndash;%&gt;--%>
<%--&lt;%&ndash;                <h1 class="more"><a href="https://www.melon.com/chart/index.htm" target="_blank"> ❯</a></h1>&ndash;%&gt;--%>

<%--&lt;%&ndash;                <ul>&ndash;%&gt;--%>
<%--&lt;%&ndash;                    <li class="one"><a href="#">&ndash;%&gt;--%>
<%--&lt;%&ndash;                        <div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                            <img class="albumAll" onclick="moveAll(event, 10)" src="../../album_img/dawnfm.jpg"&ndash;%&gt;--%>
<%--&lt;%&ndash;                                 style="width:100%" height="170" />&ndash;%&gt;--%>
<%--&lt;%&ndash;                        </div>&ndash;%&gt;--%>

<%--&lt;%&ndash;                        <div class="three">&ndash;%&gt;--%>
<%--&lt;%&ndash;                            <p>Dawn FM</p>&ndash;%&gt;--%>
<%--&lt;%&ndash;                        </div></a>&ndash;%&gt;--%>

<%--&lt;%&ndash;                        <li class="one"><a href="#">&ndash;%&gt;--%>
<%--&lt;%&ndash;                            <div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <img class="albumAll" onclick="moveAll(event, 11)" src="../../album_img/teambaby.webp"&ndash;%&gt;--%>
<%--&lt;%&ndash;                                     style="width:100%" height="170" />&ndash;%&gt;--%>
<%--&lt;%&ndash;                            </div>&ndash;%&gt;--%>

<%--&lt;%&ndash;                            <div class="three">&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <p>TEAM BABY</p>&ndash;%&gt;--%>
<%--&lt;%&ndash;                            </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                        </a></li>&ndash;%&gt;--%>

<%--&lt;%&ndash;                        <li class="one"><a href="#">&ndash;%&gt;--%>
<%--&lt;%&ndash;                            <div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <img class="albumAll" onclick="moveAll(event, 12)" src="../../album_img/love.webp"&ndash;%&gt;--%>
<%--&lt;%&ndash;                                     style="width:100%" height="170" />&ndash;%&gt;--%>
<%--&lt;%&ndash;                            </div>&ndash;%&gt;--%>

<%--&lt;%&ndash;                            <div class="three">&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <p>사랑으로</p>&ndash;%&gt;--%>
<%--&lt;%&ndash;                            </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                        </a></li>&ndash;%&gt;--%>

<%--&lt;%&ndash;                        <li class="one"><a href="#">&ndash;%&gt;--%>
<%--&lt;%&ndash;                            <div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <img class="albumAll" onclick="moveAll(event, 13)" src="../../album_img/choiyuri.jpg"&ndash;%&gt;--%>
<%--&lt;%&ndash;                                     style="width:100%" height="170" />&ndash;%&gt;--%>
<%--&lt;%&ndash;                            </div>&ndash;%&gt;--%>
...
<%--&lt;%&ndash;                        <li class="one"><a href="#">&ndash;%&gt;--%>
<%--&lt;%&ndash;                            <div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <img class="albumAll" onclick="moveAll(event, 14)" src="../../album_img/teen.jpeg"&ndash;%&gt;--%>
<%--&lt;%&ndash;                                     style="width:100%" height="170" />&ndash;%&gt;--%>
<%--&lt;%&ndash;                            </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                            <div class="three">&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <p>TEEN TROUBLES</p>&ndash;%&gt;--%>
<%--&lt;%&ndash;                            </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                        </a></li><br>&ndash;%&gt;--%>

<%--&lt;%&ndash;                        <li class="one"><a href="#">&ndash;%&gt;--%>
<%--&lt;%&ndash;                            <div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <img class="albumAll" onclick="moveAll(event, 15)" src="../../album_img/thirsty.webp"&ndash;%&gt;--%>
<%--&lt;%&ndash;                                     style="width:100%" height="170" />&ndash;%&gt;--%>
<%--&lt;%&ndash;                            </div>&ndash;%&gt;--%>

<%--&lt;%&ndash;                            <div class="three">&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <p>THIRSTY</p>&ndash;%&gt;--%>
<%--&lt;%&ndash;                            </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                        </a>&ndash;%&gt;--%>
<%--&lt;%&ndash;                        </li>&ndash;%&gt;--%>
...
<%--&lt;%&ndash;                        <li class="one"><a href="#">&ndash;%&gt;--%>
<%--&lt;%&ndash;                            <div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <img class="albumAll" onclick="moveAll(event, 16)" src="../../album_img/starboy.webp"&ndash;%&gt;--%>
<%--&lt;%&ndash;                                     style="width:100%" height="170" />&ndash;%&gt;--%>
<%--&lt;%&ndash;                            </div>&ndash;%&gt;--%>

<%--&lt;%&ndash;                            <div class="three">&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <p>Starboy</p>&ndash;%&gt;--%>
<%--&lt;%&ndash;                            </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                        </a>&ndash;%&gt;--%>
<%--&lt;%&ndash;                        </li>&ndash;%&gt;--%>
...
<%--&lt;%&ndash;                        <li class="one"><a href="#">&ndash;%&gt;--%>
<%--&lt;%&ndash;                            <div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <img class="albumAll" onclick="moveAll(event, 17)" src="../../album_img/formyangel.jpg"&ndash;%&gt;--%>
<%--&lt;%&ndash;                                     style="width:100%" height="170" />&ndash;%&gt;--%>
<%--&lt;%&ndash;                            </div>&ndash;%&gt;--%>

<%--&lt;%&ndash;                            <div class="three">&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <p>For My Angel</p>&ndash;%&gt;--%>
<%--&lt;%&ndash;                            </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                        </a>&ndash;%&gt;--%>
<%--&lt;%&ndash;                        </li>&ndash;%&gt;--%>
...
<%--&lt;%&ndash;                        <li class="one"><a href="#">&ndash;%&gt;--%>
<%--&lt;%&ndash;                            <div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <img class="albumAll" onclick="moveAll(event, 18)"&ndash;%&gt;--%>
<%--&lt;%&ndash;                                     src="../../album_img/flaws%20and%20all.png" style="width:100%" height="170" />&ndash;%&gt;--%>
<%--&lt;%&ndash;                            </div>&ndash;%&gt;--%>

<%--&lt;%&ndash;                            <div class="three">&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <p>Flaws and All</p>&ndash;%&gt;--%>
<%--&lt;%&ndash;                            </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                        </a>&ndash;%&gt;--%>
<%--&lt;%&ndash;                        </li>&ndash;%&gt;--%>
...
<%--&lt;%&ndash;                        <li class="one"><a href="#">&ndash;%&gt;--%>
<%--&lt;%&ndash;                            <div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <img class="albumAll" onclick="moveAll(event, 19)" src="../../album_img/nwjns.jpg"&ndash;%&gt;--%>
<%--&lt;%&ndash;                                     style="width:100%" height="170" />&ndash;%&gt;--%>
<%--&lt;%&ndash;                            </div>&ndash;%&gt;--%>

<%--&lt;%&ndash;                            <div class="three">&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <p>New Jeans</p>&ndash;%&gt;--%>
<%--&lt;%&ndash;                            </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                        </a>&ndash;%&gt;--%>
<%--&lt;%&ndash;                        </li>&ndash;%&gt;--%>
<%--&lt;%&ndash;                </ul>&ndash;%&gt;--%>
